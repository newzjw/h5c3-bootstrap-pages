$(function () {
    ...
    $('.container').fullpage({
        /*配置参数*/
        sectionsColor: ["#fadd67", "#84a2d4", "#ef674d", "#ffeedd", "#d04759", "#84d9ed", "#8ac060"], //设置每个section的背景颜色
        verticalCentered: false,    //设置屏幕内容的对齐方式  默认是垂直居中的  改成顶部对齐
        navigation: true, //设置导航 设置指示器 点容器
        // 进入某一屏时触发
        ...
        afterRender:function () {
            ...
            $('.screen08').on('mousemove',function (e) {
                ...
                /*2.4 加css属性  后果：加了一个style属性*/
                /*2.5 用jquery方法  show() fadeIn() 后果：加了一个style属性*/
                // 找到content里面的所有style属性，删除
        ...
        /*页面切换的时间 默认是700*/
        // 页面切换时间设置成1s，和动画时间保持一致，这样动画和页面的滚动就同步了
        scrollingSpeed:1000
    });
});